...
| Model                                                              | AVA       | OC        | SI        | FO        | HVN       | SS        | WASD      |
|:-------------------------------------------------------------------|:---------:|:---------:|:---------:|:---------:|:---------:|:---------:|:---------:|
...
|--------|------|------|------|
| clips_audios.zip | 7 GB | Preprocessed audio files | [Download](https://www.it.ubi.pt/WASD/clips_audios.zip) |
| clips_videos_body.zip | 246 GB | Preprocessed body frames | [Download](https://www.it.ubi.pt/WASD/clips_videos_body.zip) |
| clips_videos.zip | 46 GB | Preprocessed face frames | [Download](https://www.it.ubi.pt/WASD/clips_videos.zip) |
| csv.zip | 0.3 GB | CSV files | [Download](https://www.it.ubi.pt/WASD/csv.zip) |

### Option B - Preprocessing from Source

⚠️ The preprocessing downloads the WASD source videos from a Google Drive link, in `prepare_setup.py` in function `download_videos`. **If you have trouble** downloading from this link, we provide a direct link in [Here](https://www.it.ubi.pt/WASD/WASD_videos.zip)
